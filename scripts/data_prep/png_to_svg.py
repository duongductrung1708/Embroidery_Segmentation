...
if __name__ == "__main__":
    # Lấy thư mục hiện tại là scripts/data_prep/
    CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
    
    # Đi ngược lên 2 cấp để về project root
    PROJECT_ROOT = os.path.dirname(os.path.dirname(CURRENT_DIR))
    
    # Trỏ đến đúng các thư mục theo cấu trúc mới
    INPUT_DIR = os.path.join(PROJECT_ROOT, "data", "lineart", "train", "images")
    CLEAN_DIR = os.path.join(PROJECT_ROOT, "data", "lineart", "train", "clean")
